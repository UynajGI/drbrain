...
- reason：LLM 图谱智能体推理（单向/双向迭代验证）

章节来源
- [analysis_commands.py:118-678](file://src/drbrain/cli/analysis_commands.py#L118-L678)
...
章节来源
- [analysis_commands.py:214-265](file://src/drbrain/cli/analysis_commands.py#L214-L265)
- [genealogy.py:14-71](file://src/drbrain/graph/genealogy.py#L14-L71)
...
章节来源
- [analysis_commands.py:309-342](file://src/drbrain/cli/analysis_commands.py#L309-L342)
...
章节来源
- [analysis_commands.py:345-395](file://src/drbrain/cli/analysis_commands.py#L345-L395)
...
章节来源
- [analysis_commands.py:550-601](file://src/drbrain/cli/analysis_commands.py#L550-L601)
- [isomorphism.py:111-170](file://src/drbrain/extractor/isomorphism.py#L111-L170)
...
章节来源
- [analysis_commands.py:604-637](file://src/drbrain/cli/analysis_commands.py#L604-L637)
...
章节来源
- [analysis_commands.py:640-677](file://src/drbrain/cli/analysis_commands.py#L640-L677)
...
章节来源
- [analysis_commands.py:54-115](file://src/drbrain/cli/analysis_commands.py#L54-L115)
...
## 结论
DrBrain 的分析探索命令围绕“知识图谱 + 符号驱动推理”构建，既支持快速问答（ask/reason），也支持深入探索（evolve/descendants/paradigm/transfers/isomorphism/frontier/difficulty/landscape）。通过统一的数据库与图谱引擎接口，命令层保持简洁，分析模块可独立演进。建议在实际使用中：
- 先构建图谱并启用闭包与嵌入
- 使用工作空间聚焦子领域
...
章节来源
- [SKILL.md（知识图谱推理）:1-67](file://skills/kg-reason/SKILL.md#L1-L67)
