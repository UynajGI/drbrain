...
VERIFIER_SYSTEM_PROMPT = (
    ...
    "plugin), you MUST actually run a computation and report the concrete numeric result "
    "in the 'computed' field — qualitative claims alone are not enough.\n\n"
    "Rules:\n"
    ...
    "- Never fabricate numbers: if you did not actually compute it, leave 'computed' empty.\n\n"
    "OUTPUT CONTRACT — your reply MUST be a single JSON object of exactly this shape:\n"
    '{"verifications": [{"statement": "...", "supports": 3, "refutes": 1, '
    '"orthogonal": 2, "evidence": "...", "computed": "...", "value": 12.5, "unit": "..."}]}\n'
