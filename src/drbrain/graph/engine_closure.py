"""Rule-based closure mixin extracted from GraphEngine.

Provides symbolic + hybrid closure, research seed detection, and
section-aware closure variants. Mixed into ``GraphEngine`` so callers
see a single object.
"""
...
class ClosureMixin:
    """Rule-based closure and research-seed detection operations.
