...
状态：**进行中** — T01–T10 已通过契约测试（记录见 `data/integration/unified-tree/acceptance.jsonl`，提交 faac934/5d7a0cf）。已完成的源码调研不等于实现完成；模型测试、语料迁移与10k重建仍按验收门执行。
