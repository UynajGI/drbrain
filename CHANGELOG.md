...
- **Metadata cross-validation**: `arxiv` library for arXiv papers, CrossRef API for DOI + year gap-fill, `pyalex` for OpenAlex fallback on non-arXiv papers. Priority: arXiv → CrossRef → OpenAlex.
